...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.142187 && value <= -0.083090) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.083090 && value <= -0.023994) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.023994 && value <= 0.035103) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.035103 && value <= 0.094200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.094200 && value <= 0.153296) {
            style = [ new ol.style.Style({
