...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.122553 && value <= 0.215418) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.215418 && value <= 0.308282) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.308282 && value <= 0.401147) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.401147 && value <= 0.494012) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.494012 && value <= 0.586877) {
            style = [ new ol.style.Style({
